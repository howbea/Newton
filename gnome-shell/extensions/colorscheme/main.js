...
const _sysSettings = new Gio.Settings({
...
function _getDefaultStylesheet() {
    ...
    if (_sysSettings.get_string('color-scheme') === 'prefer-light')
        stylesheet = _getStylesheet(sessionMode.stylesheetName.replace('.css', '-light.css'));
